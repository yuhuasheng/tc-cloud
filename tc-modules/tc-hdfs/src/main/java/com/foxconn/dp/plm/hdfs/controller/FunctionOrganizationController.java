...
@Api(tags = "FunctionOrganization配置")
@RestController()
@RequestMapping("/functionOrganization")
public class FunctionOrganizationController {
    private static Log log = LogFactory.get();

    @Resource
    FunctionOrganizationService functionConfigService;


    @ApiOperation("获取已存在functionOrganization配置")
