...
public class DesUtils {
    ...
    private static final String key = "x.H@7h21*z%u?GCt{m";
    ...
    public static String encode(String data) {
        ...
        return desCore.strEnc(data, key, "", "");
    }
    ...
    public static String decode(String data) {
        ...
        return desCore.strDec(data, key, "", "");
    }
        ...
        public String strEnc(String data, String firstKey, String secondKey, String thirdKey) {
            ...
            if (leng > 0) {
                if (leng < 4) {
                    int[] bt = strToBt(data);
                    int[] encByte = null;
                    if (firstKey != null && !firstKey.equals("") && secondKey != null && !secondKey.equals("") && thirdKey != null) {
                        int[] tempBt;
                        int x, y, z;
                        tempBt = bt;
    ...
    public static void main(String[] args) {
        String amind = encode("empId=MW00343");
        System.out.println(amind);
        System.out.println(decode(amind));
    }
}
